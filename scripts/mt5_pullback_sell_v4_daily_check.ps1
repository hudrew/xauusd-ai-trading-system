...
$paperStatusScriptPath = Join-Path $PSScriptRoot "mt5_pullback_sell_v4_task_status.ps1"
$monitoringStatusScriptPath = Join-Path $PSScriptRoot "mt5_pullback_sell_v4_monitoring_task_status.ps1"
